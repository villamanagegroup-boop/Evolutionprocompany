...
export default function ContactForm() {
  ...
  const inputClass =
    "w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-cream font-dm text-sm placeholder-cream/30 focus:outline-none focus:border-gold/50 focus:bg-white/8 transition-all duration-200";

  return (
    <section id="register" className="relative py-16 md:py-20 bg-dark overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="h-px w-32 mx-auto bg-gradient-to-r from-purple via-magenta to-red rounded-full mb-10" />
        <div className="relative text-center mb-10">
          ...
          <p className="mt-4 font-dm text-cream/60 text-base max-w-md mx-auto">
            Auditions are coming to the DMV. Fill out this form and be the
            first to know when dates are announced.
          </p>
        </div>
          ...
          {status === "success" ? (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="font-dm text-cream/80 text-base">
                  We&apos;ve received your interest. Check your email for
                  confirmation — we&apos;ll be in touch when audition dates are
                  announced.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  placeholder="Tell us about your performance background, training history, and what you're looking for..."
                  className={inputClass + " resize-none"}
                />
              </div>

              {status === "error" && (
                <p className="text-red text-sm font-dm">{errorMsg}</p>
              )}
