...
export const MEMBERSHIP_TIERS = [
  {
    name: "Company Member",
    price: "$175/mo",
    description: "Core company membership with full production access.",
    features: [
      "2x weekly training sessions (ice + off-ice)",
      "All 3 annual productions",
      "Professional choreography curriculum",
      "Conditioning & flexibility coaching",
  ...
  },
  {
    name: "Elite Package",
    price: "$225/mo",
    description: "Everything in Company Member plus career-building extras.",
    features: [
      "All Company Member benefits",
      "Production fee included",
      "Headshot session (annual)",
      "Video reel compilation",
      "NIL agent connections",
...
export const AUDITION_TIERS = [
  {
    ...
    requirements: [
      ...
      "Prepare a 60-second solo in your primary discipline",
  ...
  },
  {
    ...
    requirements: [
      ...
      "Prepare a 90-second solo in your primary discipline",
